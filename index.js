(function () {
    ...
    function findAll(filter) {
      return clientWebpack.getAllModules((x) => x?.default && filter(x), false) || clientWebpack.getModule(filter, false);
    }
    ...
    function authorize(callback) {
      ...
      openModal((props) => react.createElement(OAuth2AuthorizeModal, {
        ...props,
        ...opts,
        responseType: "code",
    ...
    class ReviewComponent extends react.Component {
      constructor(props) {
        super(props);
        this.openModal = () => {
          if (Users.getUser(this.props.review.senderdiscordid) === void 0) {
